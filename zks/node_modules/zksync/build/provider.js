    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (network === 'localhost') {
            if (transport === 'WS') {
                ...
                return yield Provider.newHttpProvider('http://127.0.0.1:3030', pollIntervalMilliSecs);
            }
        }
            ...
            if (transport === 'WS') {
                ...
                return yield Provider.newHttpProvider('https://ropsten-api.zksync.io/jsrpc', pollIntervalMilliSecs);
            }
        }
            ...
            if (transport === 'WS') {
                ...
                return yield Provider.newHttpProvider('https://rinkeby-api.zksync.io/jsrpc', pollIntervalMilliSecs);
            }
        }
            ...
            if (transport === 'WS') {
                ...
                return yield Provider.newHttpProvider('https://ropsten-beta-api.zksync.io/jsrpc', pollIntervalMilliSecs);
            }
        }
            ...
            if (transport === 'WS') {
                ...
                return yield Provider.newHttpProvider('https://rinkeby-beta-api.zksync.io/jsrpc', pollIntervalMilliSecs);
            }
        }
            ...
            if (transport === 'WS') {
                ...
                return yield Provider.newHttpProvider('https://api.zksync.io/jsrpc', pollIntervalMilliSecs);
            }
        }
        else {
