...
function getDefaultRestProvider(network, pollIntervalMilliSecs) {
    return __awaiter(this, void 0, void 0, function* () {
        if (network === 'localhost') {
            return yield RestProvider.newProvider('http://127.0.0.1:3001/api/v0.2', pollIntervalMilliSecs);
        }
        else if (network === 'ropsten') {
            return yield RestProvider.newProvider('https://ropsten-api.zksync.io/api/v0.2', pollIntervalMilliSecs);
        }
        else if (network === 'rinkeby') {
            return yield RestProvider.newProvider('https://rinkeby-api.zksync.io/api/v0.2', pollIntervalMilliSecs);
        }
        else if (network === 'ropsten-beta') {
            return yield RestProvider.newProvider('https://ropsten-beta-api.zksync.io/api/v0.2', pollIntervalMilliSecs);
        }
        else if (network === 'rinkeby-beta') {
            return yield RestProvider.newProvider('https://rinkeby-beta-api.zksync.io/api/v0.2', pollIntervalMilliSecs);
        }
        else if (network === 'mainnet') {
            return yield RestProvider.newProvider('https://api.zksync.io/api/v0.2', pollIntervalMilliSecs);
        }
        else {
