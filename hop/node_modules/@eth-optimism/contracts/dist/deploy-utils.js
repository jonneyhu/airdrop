...
const deployAndVerifyAndThen = async ({ hre, name, args, contract, iface, postDeployAction, }) => {
    ...
    if (result.newlyDeployed) {
        if (!(await exports.isHardhatNode(hre))) {
            try {
        ...
        if (postDeployAction) {
            ...
            await postDeployAction(exports.getAdvancedContract({
                hre,
...
const fundAccount = async (hre, address, amount) => {
    ...
    await core_utils_1.awaitCondition(async () => {
...
const sendImpersonatedTx = async (opts) => {
    if (opts.hre.deployConfig.forked !== 'true') {
        throw new Error('this method can only be used against a forked network');
    }
    ...
    await exports.fundAccount(opts.hre, opts.from, exports.BIG_BALANCE);
...
const getContractFromArtifact = async (hre, name, options = {}) => {
    ...
    return exports.getAdvancedContract({
        hre,
