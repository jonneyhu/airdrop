...
exports.printComparison = exports.getEtherscanUrl = exports.getArtifact = exports.color = exports.getInput = void 0;
...
const printComparison = (action, description, expected, deployed) => {
    console.log(action + ':');
    if (core_utils_1.hexStringEquals(expected.value, deployed.value)) {
