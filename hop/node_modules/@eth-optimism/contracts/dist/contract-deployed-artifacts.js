...
const goerli__Proxy__L1StandardBridge = require('../deployments/goerli/Proxy__L1StandardBridge.json');
...
const mainnet_trial__AddressDictator = require('../deployments/mainnet-trial/AddressDictator.json');
const mainnet_trial__BondManager = require('../deployments/mainnet-trial/BondManager.json');
const mainnet_trial__CanonicalTransactionChain = require('../deployments/mainnet-trial/CanonicalTransactionChain.json');
const mainnet_trial__ChainStorageContainer_CTC_batches = require('../deployments/mainnet-trial/ChainStorageContainer-CTC-batches.json');
const mainnet_trial__ChainStorageContainer_SCC_batches = require('../deployments/mainnet-trial/ChainStorageContainer-SCC-batches.json');
const mainnet_trial__ChugSplashDictator = require('../deployments/mainnet-trial/ChugSplashDictator.json');
const mainnet_trial__L1StandardBridge_for_verification_only = require('../deployments/mainnet-trial/L1StandardBridge_for_verification_only.json');
const mainnet_trial__Lib_AddressManager = require('../deployments/mainnet-trial/Lib_AddressManager.json');
const mainnet_trial__OVM_L1CrossDomainMessenger = require('../deployments/mainnet-trial/OVM_L1CrossDomainMessenger.json');
const mainnet_trial__Proxy__OVM_L1CrossDomainMessenger = require('../deployments/mainnet-trial/Proxy__OVM_L1CrossDomainMessenger.json');
const mainnet_trial__Proxy__OVM_L1StandardBridge = require('../deployments/mainnet-trial/Proxy__OVM_L1StandardBridge.json');
const mainnet_trial__StateCommitmentChain = require('../deployments/mainnet-trial/StateCommitmentChain.json');
const mainnet_trial_2__AddressDictator = require('../deployments/mainnet-trial-2/AddressDictator.json');
const mainnet_trial_2__BondManager = require('../deployments/mainnet-trial-2/BondManager.json');
const mainnet_trial_2__CanonicalTransactionChain = require('../deployments/mainnet-trial-2/CanonicalTransactionChain.json');
const mainnet_trial_2__ChainStorageContainer_CTC_batches = require('../deployments/mainnet-trial-2/ChainStorageContainer-CTC-batches.json');
const mainnet_trial_2__ChainStorageContainer_SCC_batches = require('../deployments/mainnet-trial-2/ChainStorageContainer-SCC-batches.json');
const mainnet_trial_2__ChugSplashDictator = require('../deployments/mainnet-trial-2/ChugSplashDictator.json');
const mainnet_trial_2__L1StandardBridge_for_verification_only = require('../deployments/mainnet-trial-2/L1StandardBridge_for_verification_only.json');
const mainnet_trial_2__Lib_AddressManager = require('../deployments/mainnet-trial-2/Lib_AddressManager.json');
const mainnet_trial_2__OVM_L1CrossDomainMessenger = require('../deployments/mainnet-trial-2/OVM_L1CrossDomainMessenger.json');
const mainnet_trial_2__Proxy__OVM_L1CrossDomainMessenger = require('../deployments/mainnet-trial-2/Proxy__OVM_L1CrossDomainMessenger.json');
const mainnet_trial_2__Proxy__OVM_L1StandardBridge = require('../deployments/mainnet-trial-2/Proxy__OVM_L1StandardBridge.json');
const mainnet_trial_2__StateCommitmentChain = require('../deployments/mainnet-trial-2/StateCommitmentChain.json');
const getDeployedContractArtifact = (name, network) => {
    return {
        ...
        goerli__Proxy__L1StandardBridge,
        ...
        mainnet_trial__AddressDictator,
        mainnet_trial__BondManager,
        mainnet_trial__CanonicalTransactionChain,
        mainnet_trial__ChainStorageContainer_CTC_batches,
        mainnet_trial__ChainStorageContainer_SCC_batches,
        mainnet_trial__ChugSplashDictator,
        mainnet_trial__L1StandardBridge_for_verification_only,
        mainnet_trial__Lib_AddressManager,
        mainnet_trial__OVM_L1CrossDomainMessenger,
        mainnet_trial__Proxy__OVM_L1CrossDomainMessenger,
        mainnet_trial__Proxy__OVM_L1StandardBridge,
        mainnet_trial__StateCommitmentChain,
        mainnet_trial_2__AddressDictator,
        mainnet_trial_2__BondManager,
        mainnet_trial_2__CanonicalTransactionChain,
        mainnet_trial_2__ChainStorageContainer_CTC_batches,
        mainnet_trial_2__ChainStorageContainer_SCC_batches,
        mainnet_trial_2__ChugSplashDictator,
        mainnet_trial_2__L1StandardBridge_for_verification_only,
        mainnet_trial_2__Lib_AddressManager,
        mainnet_trial_2__OVM_L1CrossDomainMessenger,
        mainnet_trial_2__Proxy__OVM_L1CrossDomainMessenger,
        mainnet_trial_2__Proxy__OVM_L1StandardBridge,
        mainnet_trial_2__StateCommitmentChain
