...
declare class HopBridge extends Base {
    ...
    getSendHTokensEstimatedGas(sourceChain: TChain, destinationChain: TChain, options?: Partial<SendOptions>): Promise<any>;
    ...
    getBondWithdrawalEstimatedGas(destinationChain: TChain): Promise<any>;
    /**
    ...
    removeLiquidityOneToken(lpTokenAmount: TAmount, tokenIndex: number, chain?: TChain, options?: Partial<RemoveLiquidityOneTokenOptions>): Promise<any>;
    removeLiquidityImbalance(token0Amount: TAmount, token1Amount: TAmount, chain?: TChain, options?: Partial<RemoveLiquidityImbalanceOptions>): Promise<any>;
    /**
