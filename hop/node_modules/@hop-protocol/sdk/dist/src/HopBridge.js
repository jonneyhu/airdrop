...
class HopBridge extends Base_1.default {
    ...
    getSendHTokensEstimatedGas(sourceChain, destinationChain, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            options.populateTxOnly = true;
            const tokenAmount = ethers_1.BigNumber.from(1);
    ...
    getSendData(amountIn, sourceChain, destinationChain, deadline) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let totalFee = ethers_1.BigNumber.from(0);
            let adjustedBonderFee = ethers_1.BigNumber.from(0);
            let adjustedDestinationTxFee = ethers_1.BigNumber.from(0);
            if (!sourceChain.isL1) {
    ...
    getDestinationTransactionFee(sourceChain, destinationChain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (destinationChain.equals(Chain_1.default.Optimism)) {
                try {
                    const { gasLimit, data, to } = yield this.getBondWithdrawalEstimatedGas(destinationChain);
                    const l1FeeInWei = yield this.getOptimismL1Fee(gasLimit, data, to);
            ...
            try {
                ...
                if (attemptSwap && !destinationChain.isL1) {
                    ...
                    const [gasLimit, tx] = yield Promise.all([
                        destinationBridge.estimateGas.bondWithdrawalAndDistribute(...payload),
                        destinationBridge.populateTransaction.bondWithdrawalAndDistribute(...payload)
                    ]);
                    ...
                    const [gasLimit, tx] = yield Promise.all([
                        destinationBridge.estimateGas.bondWithdrawal(...payload),
                        destinationBridge.populateTransaction.bondWithdrawal(...payload)
                    ]);
                    return Object.assign({ gasLimit }, tx);
                }
            }
    ...
    sendHTokenHandler(tokenAmount, sourceChain, destinationChain, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!sourceChain.isL1) {
                const deadline = 0;
                defaultBonderFee = yield this.getTotalFee(tokenAmount, sourceChain, destinationChain, deadline);
            }
