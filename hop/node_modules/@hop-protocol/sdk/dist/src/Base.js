...
const getContractMemo = (0, fast_memoize_1.default)((address, abi, cacheKey) => {
    let cached;
    return (provider) => {
        if (!cached) {
            cached = new ethers_1.Contract(address, abi, provider);
        }
        return cached;
    };
});
// cache contract
const getContract = (address, abi, provider) => __awaiter(void 0, void 0, void 0, function* () {
...
class Base {
    ...
    constructor(network, signer, chainProviders) {
        this.chainProviders = {};
        this.addresses = config_1.config.addresses;
        this.chains = config_1.config.chains;
        this.bonders = config_1.config.bonders;
        this.fees = config_1.config.fees;
        ...
        if (!this.isValidNetwork(network)) {
            throw new Error(`network is unsupported. Supported networks are: ${this.supportedNetworks.join(',')}`);
        }
    ...
    getConfigAddresses(token, chain) {
        ...
        chain = this.toChainModel(chain);
        return (_b = (_a = this.addresses[this.network]) === null || _a === void 0 ? void 0 : _a[token.canonicalSymbol]) === null || _b === void 0 ? void 0 : _b[chain.slug];
    }
    ...
    getBonderAddress(token) {
        var _a, _b, _c;
        token = this.toTokenModel(token);
        return (_c = (_b = (_a = this.bonders) === null || _a === void 0 ? void 0 : _a[this.network]) === null || _b === void 0 ? void 0 : _b[token.canonicalSymbol]) === null || _c === void 0 ? void 0 : _c[0];
    }
    getBonderAddresses(token) {
        var _a, _b;
        token = this.toTokenModel(token);
        return (_b = (_a = this.bonders) === null || _a === void 0 ? void 0 : _a[this.network]) === null || _b === void 0 ? void 0 : _b[token.canonicalSymbol];
    }
    getFeeBps(token, destinationChain) {
        ...
        const fees = (_a = config_1.config.fees) === null || _a === void 0 ? void 0 : _a[token === null || token === void 0 ? void 0 : token.canonicalSymbol];
        if (!fees) {
            throw new Error('fee data not found');
        }
        let feeBps = fees === null || fees === void 0 ? void 0 : fees.L2ToL2;
        if (destinationChain.isL1) {
            feeBps = fees === null || fees === void 0 ? void 0 : fees.L2ToL1;
        }
        if (destinationChain.equals(models_1.Chain.xDai) && (fees === null || fees === void 0 ? void 0 : fees.anyToxDai)) {
            feeBps = fees === null || fees === void 0 ? void 0 : fees.anyToxDai;
        }
        return feeBps;
    }
