...
declare class Token extends Base {
     ...
     */
    constructor(network: string, chain: TChain, address: string, decimals: number, symbol: string, name: string, image: string, signer?: Signer | providers.Provider, chainProviders?: ChainProviders);
    get symbol(): string;
    /**
     ...
     *```
     */
    transfer(recipient: string, amount: TAmount): Promise<any>;
    /**
     ...
     *```
     */
    approve(spender: string, amount?: TAmount): Promise<any>;
    /**
    ...
    getWethContract(chain: TChain): Promise<Contract>;
    getWrappedToken(): Token;
    wrapToken(amount: TAmount, estimateGasOnly?: boolean): Promise<any>;
    unwrapToken(amount: TAmount): Promise<any>;
