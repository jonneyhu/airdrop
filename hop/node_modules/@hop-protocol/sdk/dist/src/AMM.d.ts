...
declare class AMM extends Base {
    ...
    removeLiquidityOneToken(lpAmount: TAmount, tokenIndex: number, amountMin?: TAmount, deadline?: BigNumberish): Promise<any>;
    removeLiquidityImbalance(amount0: TAmount, amount1: TAmount, maxBurnAmount?: TAmount, deadline?: BigNumberish): Promise<any>;
    ...
    calculateRemoveLiquidityMinimumLpTokens(amount0: TAmount, amount1: TAmount): Promise<any>;
    /**
