...
class L1ToL2Watcher extends BaseWatcher_1.default {
    ...
    pollFn() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.destinationChain.equals(models_1.Chain.xDai)) {
    ...
    xDaiWatcher() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ambBridge = yield canonicalBridge.getAmbBridge(models_1.Chain.xDai);
            const filter = {
                address: this.getL2CanonicalTokenAddress(this.token, models_1.Chain.xDai)
            };
    ...
    polygonWatcher() {
        return __awaiter(this, void 0, void 0, function* () {
            let startBlock = -1;
            let endBlock = -1;
            const canonicalBridge = new CanonicalBridge_1.default(this.network, this.signer, this.token, models_1.Chain.Polygon);
            const tokenBridge = yield canonicalBridge.getL2CanonicalBridge();
            const filter = {
                address: canonicalBridge.getL2CanonicalTokenAddress(this.token, models_1.Chain.Polygon)
            };
            const handleEvent = (...args) => __awaiter(this, void 0, void 0, function* () {
                const event = args[args.length - 1];
                const receipt = yield event.getTransactionReceipt();
            ...
            return () => __awaiter(this, void 0, void 0, function* () {
                ...
                endBlock = blockNumber;
                const events = ((_a = (yield tokenBridge.queryFilter(filter, startBlock, endBlock))) !== null && _a !== void 0 ? _a : []).reverse();
                if (!events || !events.length) {
                    return false;
                }
                for (const event of events) {
